...
- > **"İskender'in hayatını okuyarak onunla yarışan birisinin burada durması zaten mümkün değildir. - Fatih Sultan Mehmet"**
- > **"Eğitimin kökleri acı, meyveleri tatlıdır. - Aristoteles"**
- > **"Bana ordular verin fethedeyim, bilge adamlar verin dünyayı yöneteyim. - Büyük İskender"**
- > **"Önce doğruyu bilmek gerekir, doğru bilinirse yanlış da bilinir; ama önce yanlış bilinirse doğruya ulaşılamaz. - Farabi"**
- > **"İnanç, surlardan daha sağlamdır. Surları mancınık yıkar, inancı hiçbir şüphe yıkamaz. - Akşemseddin"**
<!-- END_QUOTE -->
